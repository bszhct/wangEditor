...
function Justify (editor) {
  ...
  // 初始化 droplist
    ...
    // $title: $('<p>对齐方式</p>'),
      ...
      { $elem: $('<i class="w-e-icon-paragraph-left"></i>'), value: 'justifyLeft' },
      { $elem: $('<i class="w-e-icon-paragraph-center"></i>'), value: 'justifyCenter' },
      { $elem: $('<i class="w-e-icon-paragraph-right"></i>'), value: 'justifyRight' }
        ],
        onClick: (value) => {
